...
namespace klee {
  ...
  public:
    ...
    // Functions defined by klee
    std::set<const llvm::Function*> kleeFunctions;

    // Intrinsic Functions, they are system functions and replaced by klee, such as memcpy
    std::set<const llvm::Function*> intrinsicFunctions;
